...
extension URL {
    ...
    static internal let DEFAULT_MIME_TYPE = "application/octet-stream"
    static internal let mimeTypes = [
        "html": "text/html",
        "htm": "text/html",
        "shtml": "text/html",
        "css": "text/css",
    ...
    var mimeType:String {
        return URL.mimeTypes[self.pathExtension] ?? URL.DEFAULT_MIME_TYPE
    }
